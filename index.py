...
idList[326] = {'id':340, 'name':'瓦波爾'}
idList[327] = {'id':341, 'name':'瓦波爾房屋'}
...
idList[500] = {'id':511, 'name':'ベルメール', 'title':'ナミとノジコの養母'}
idList[501] = {'id':512, 'name':'カヤ'}
...
idList[530] = {'id':525, 'name':'シャンクス', 'title':'黒衣の四皇'}
...
idList[588] = {'id':541, 'name':'クロッカス', 'title':'双子岬の灯台守'}
...
idList[594] = {'id':557, 'name':'琥珀の竜宮カメ姫', 'skill':-1}
...
idList[603] = {'id':653, 'name':'Eneru, Lightning Incarnate', 'skill':652}
idList[619] = {'id':767, 'name':'ナックルチンピラ', 'title':'緑の賞金稼ぎ', 'skill':8095}
idList[620] = {'id':768, 'name':'カタナチンピラ', 'title':'青の賞金稼ぎ', 'skill':8030}
idList[622] = {'id':770, 'name':'ピストルチンピラ', 'title':'緑の賞金稼ぎ', 'skill':8096}
idList[623] = {'id':771, 'name':'ピストルチンピラ', 'title':'黄の賞金稼ぎ'}
idList[624] = {'id':772, 'name':'棍棒チンピラ', 'title':'黄の賞金稼ぎ'}
idList[626] = {'id':774, 'name':'ガトリングチンピラ', 'title':'黒の賞金稼ぎ'}
idList[627] = {'id':775, 'name':'ガトリングチンピラ', 'title':'青の賞金稼ぎ'}
...
idList[674] = {'id':732, 'name':'エンポリオ・イワンコフ', 'title':'ニューカマー拳法　師範'}
...
idList[691] = {'id':715, 'name':'ナギナタ伍長', 'title':'海軍本部'}
idList[692] = {'id':716, 'name':'ピストル伍長', 'title':'海軍本部'}
idList[693] = {'id':717, 'name':'サーベル伍長', 'title':'海軍本部', 'skill':8015}
idList[694] = {'id':718, 'name':'バズーカ伍長', 'title':'海軍本部'}
idList[698] = {'id':757, 'name':'サーベル少佐', 'title':'海軍本部', 'skill':8015}
idList[700] = {'id':759, 'name':'ナックル少佐', 'title':'海軍本部'}
...
idList[758] = {'id':876, 'name':'フクロウ', 'title':'歴代最強の「ＣＰ９」'}
...
idList[773] = {'id':807, 'name':'シュウ'}
idList[774] = {'id':808, 'name':'ベリーグッド'}
idList[775] = {'id':809, 'name':'ストロベリー', 'title':'海軍本部中将'}
...
idList[818] = {'id':1005, 'name':'ソルジャーゾンビ　素早さの影'}
...
idList[999] = {'id':1125, 'name':'ディアマンテ', 'title':'ドンキホーテ海賊団'}
...
idList[1014] = {'id':1156, 'name':'トニートニー・チョッパー', 'title':'動物王'}
