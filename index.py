...
idList[31] = {'id':136, 'name':'克比'}
idList[32] = {'id':137, 'name':'打雜的克比'}
idList[33] = {'id':139, 'name':'貝魯梅柏'}
...
idList[51] = {'id':148, 'name':'卡爾涅'}
idList[52] = {'id':149, 'name':'主廚哲普'}
idList[53] = {'id':158, 'name':'銀仔'}
idList[54] = {'id':159, 'name':'鬼人銀仔'}
idList[55] = {'id':156, 'name':'帕魯'}
...
idList[78] = {'id':82, 'name':'紅色小偷企鵝'}
idList[79] = {'id':83, 'name':'藍色小偷企鵝'}
idList[80] = {'id':84, 'name':'綠色小偷企鵝'}
idList[81] = {'id':85, 'name':'黃色小偷企鵝'}
idList[82] = {'id':86, 'name':'黑色小偷企鵝'}
idList[83] = {'id':87, 'name':'彩虹小偷企鵝'}
idList[84] = {'id':88, 'name':'紅色海賊企鵝'}
idList[85] = {'id':89, 'name':'藍色海賊企鵝'}
idList[86] = {'id':90, 'name':'綠色海賊企鵝'}
idList[87] = {'id':91, 'name':'黃色海賊企鵝'}
idList[88] = {'id':92, 'name':'黑色海賊企鵝'}
idList[89] = {'id':94, 'name':'紅色頭盔寄居蟹'}
idList[90] = {'id':95, 'name':'藍色頭盔寄居蟹'}
idList[91] = {'id':96, 'name':'綠色頭盔寄居蟹'}
idList[92] = {'id':97, 'name':'黃色頭盔寄居蟹'}
idList[93] = {'id':98, 'name':'黑色頭盔寄居蟹'}
idList[94] = {'id':99, 'name':'彩虹頭盔寄居蟹'}
idList[95] = {'id':100, 'name':'紅色鎧甲蟹'}
idList[96] = {'id':101, 'name':'藍色鎧甲蟹'}
idList[97] = {'id':102, 'name':'綠色鎧甲蟹'}
idList[98] = {'id':103, 'name':'黃色鎧甲蟹'}
idList[99] = {'id':104, 'name':'黑色鎧甲蟹'}
idList[100] = {'id':112, 'name':'紅色守護龍'}
idList[101] = {'id':113, 'name':'藍色守護龍'}
idList[102] = {'id':114, 'name':'綠色守護龍'}
idList[103] = {'id':115, 'name':'黃色守護龍'}
idList[104] = {'id':116, 'name':'黑色守護龍'}
idList[105] = {'id':118, 'name':'紅色寶石龜'}
idList[106] = {'id':119, 'name':'藍色寶石龜'}
idList[107] = {'id':120, 'name':'綠色寶石龜'}
idList[108] = {'id':121, 'name':'黃色寶石龜'}
idList[109] = {'id':122, 'name':'黑色寶石龜'}
idList[110] = {'id':123, 'name':'紅色領主海龜'}
idList[111] = {'id':124, 'name':'藍色領主海龜'}
idList[112] = {'id':125, 'name':'綠色領主海龜'}
idList[113] = {'id':126, 'name':'黃色領主海龜'}
idList[114] = {'id':127, 'name':'黑色領主海龜'}
idList[115] = {'id':78, 'name':'海馬'}
idList[116] = {'id':79, 'name':'海馬王子'}
idList[117] = {'id':80, 'name':'海馬皇太子'}
idList[118] = {'id':81, 'name':'海馬王'}
...
idList[189] = {'id':128, 'name':'紅色長老海龜'}
idList[190] = {'id':129, 'name':'藍色長老海龜'}
idList[191] = {'id':130, 'name':'綠色長老海龜'}
idList[192] = {'id':131, 'name':'黃色長老海龜'}
idList[193] = {'id':132, 'name':'黑色長老海龜'}
...
idList[233] = {'id':244, 'name':'Mr.8'}
idList[234] = {'id':245, 'name':'Mr.8', 'title':'捲毛砲'}
idList[235] = {'id':246, 'name':'Miss星期一'}
...
idList[262] = {'id':305, 'name':'特訓克比'}
idList[263] = {'id':306, 'name':'克比上士'}
idList[264] = {'id':307, 'name':'特訓貝魯梅柏'}
idList[265] = {'id':308, 'name':'貝魯梅柏中士'}
idList[266] = {'id':93, 'name':'彩虹海賊企鵝'}
...
idList[300] = {'id':106, 'name':'紅色鎧甲龍蝦'}
idList[301] = {'id':107, 'name':'藍色鎧甲龍蝦'}
idList[302] = {'id':108, 'name':'綠色鎧甲龍蝦'}
idList[303] = {'id':109, 'name':'黃色鎧甲龍蝦'}
idList[304] = {'id':110, 'name':'黑色鎧甲龍蝦'}
...
idList[330] = {'id':344, 'name':'傑斯'}
idList[331] = {'id':345, 'name':'克羅馬利蒙'}
...
idList[342] = {'id':405, 'name':'紅色能量豬'}
idList[343] = {'id':406, 'name':'藍色能量豬'}
idList[344] = {'id':407, 'name':'綠色能量豬'}
idList[345] = {'id':408, 'name':'黃色能量豬'}
idList[346] = {'id':409, 'name':'黑色能量豬'}
idList[347] = {'id':410, 'name':'紅寶石能量豬'}
idList[348] = {'id':411, 'name':'藍寶石能量豬'}
idList[349] = {'id':412, 'name':'綠寶石能量豬'}
idList[350] = {'id':413, 'name':'黃寶石能量豬'}
idList[351] = {'id':414, 'name':'紫水晶能量豬'}
...
idList[441] = {'id':459, 'name':'牛仔跟波旁二世', 'title':'超級飛毛腿部隊'}
idList[442] = {'id':460, 'name':'史東普跟伊旺X', 'title':'超級飛毛腿部隊'}
idList[443] = {'id':461, 'name':'人頭馬跟彥一', 'title':'超級飛毛腿部隊'}
idList[444] = {'id':457, 'name':'飛毛腿'}
...
idList[477] = {'id':577, 'name':'紅色突擊隊 隊員', 'title':'SKYPIEA神兵'}
idList[478] = {'id':578, 'name':'藍色突擊隊 隊員', 'title':'SKYPIEA神兵', 'skill':8025}
idList[479] = {'id':579, 'name':'綠色突擊隊 隊員', 'title':'SKYPIEA神兵'}
